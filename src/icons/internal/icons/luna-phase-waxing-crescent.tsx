...
function LunaPhaseWaxingCrescentBase({
  title,
  decorative = true,
  children,
  ...props
    ...
    >
      ...
      <defs>
        <mask id={maskId}>
          ...
          <circle cx="15.9" cy="12" r="6.5" fill="black" />
        </mask>
      </defs>
...
export function LunaPhaseWaxingCrescentOutline(props: LunaIconSvgProps) {
  return (
    <LunaPhaseWaxingCrescentBase {...props}>
      <circle cx="12" cy="12" r="7.5" fill="currentColor" opacity="0.92" />
    </LunaPhaseWaxingCrescentBase>
  );
}

export function LunaPhaseWaxingCrescentFilled(props: LunaIconSvgProps) {
  return (
    <LunaPhaseWaxingCrescentBase {...props}>
...
export default LunaPhaseWaxingCrescentOutline;
